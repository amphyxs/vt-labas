...
import lab7.client.presenter.exceptions.BadCommandArgsNumberException;
import lab7.client.presenter.exceptions.CommandNotFoundException;
import lab7.client.presenter.exceptions.InputEndedException;
import lab7.client.presenter.exceptions.NullCommandException;
...
public class LocalStreamView implements View {
    ...
    @Override
    public boolean askYesOrNo(String message) throws InputEndedException {
        String answer = "";
