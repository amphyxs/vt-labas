...
public class SpaceMarine extends EntityWithId implements Comparable<SpaceMarine> {
     ...
     */
    public SpaceMarine(
            int id, String name, Coordinates coordinates, Long health, AstartesCategory category, Weapon weaponType, MeleeWeapon meleeWeapon, Chapter chapter, User owner
    ...
    public SpaceMarine(
        ...
        this(id, name, coordinates, health, category, weaponType, meleeWeapon, chapter, null);
    }
    ...
    public String toString() {
        String creationDateString = DateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.SHORT, new Locale("ru")).format(getCreationDate());
        String result = String.format("ID: %d\n" +
                ...
                getId(), getName(), getCoordinates(), creationDateString, getHealth(), getCategory(), getWeaponType(), getMeleeWeapon(), getChapter()
        );
        if (getOwner() != null)
            result += String.format("\nИмя владельца: %s", getOwner().getName());
